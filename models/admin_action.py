...
class AdminAction:
    ...
    def __init__(self, action: str, date: str, user_id: int, user_username: str, user_firstname: str, user_lastname: str, total_channel_members: int, total_joined: int, total_left: int):
        self.action = action
        self.date = date
